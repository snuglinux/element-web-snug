...
function computeHeaderSpaceState(
    ...
    const allowPublicRooms = SettingsStore.getValue(UIFeature.AllowCreatingPublicRooms);
    const allowPrivateRooms = SettingsStore.getValue(UIFeature.AllowCreatingPrivateRooms);
